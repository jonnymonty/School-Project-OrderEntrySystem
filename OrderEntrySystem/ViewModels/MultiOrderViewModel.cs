...
namespace OrderEntrySystem
{
    public class MultiOrderViewModel : WorkspaceViewModel
    {
        ...
        protected override void CreateCommands()
        {
            ...
            {
                this.Commands.Add(new CommandViewModel("Place", new DelegateCommand(param => this.PlaceOrder(), p => this.NumberOfItemsSelected == 1 && this.IsOrderPending == true)));
                this.Commands.Add(new CommandViewModel("New...", new DelegateCommand(param => this.CreateNewOrderExecute())));
                this.Commands.Add(new CommandViewModel("Edit...", new DelegateCommand(param => this.EditOrderExecute(), p => this.NumberOfItemsSelected == 1 && this.IsOrderPending == true)));
                this.Commands.Add(new CommandViewModel("Delete", new DelegateCommand(param => this.DeleteOrderExecute(), p => this.NumberOfItemsSelected == 1 && this.IsOrderPending == true)));
            }
        }
